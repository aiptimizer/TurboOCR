...
turboocr-cpu-server: /home/nataell/code/epAiland/paddle-highspeed-cpp/third_party/onnxruntime/lib/libonnxruntime.so \
  /home/nataell/code/epAiland/paddle-highspeed-cpp/third_party/pdfium/lib/libpdfium.so \
  /lib/libuuid.so \
  /usr/lib/Scrt1.o \
  /usr/lib/crti.o \
  /usr/lib/crtn.o \
  ...
  /usr/lib/libaddress_sorting.so.53.0.0 \
  ...
  /usr/lib/libupb_base_lib.so.53.0.0 \
  /usr/lib/libupb_hash_lib.so.53.0.0 \
  /usr/lib/libupb_json_lib.so.53.0.0 \
  /usr/lib/libupb_lex_lib.so.53.0.0 \
  /usr/lib/libupb_mem_lib.so.53.0.0 \
  /usr/lib/libupb_message_lib.so.53.0.0 \
  /usr/lib/libupb_mini_descriptor_lib.so.53.0.0 \
  /usr/lib/libupb_mini_table_lib.so.53.0.0 \
  /usr/lib/libupb_reflection_lib.so.53.0.0 \
  /usr/lib/libupb_textformat_lib.so.53.0.0 \
  /usr/lib/libupb_wire_lib.so.53.0.0 \
  /usr/lib/libutf8_range_lib.so.53.0.0 \
  /usr/lib/libutf8_validity.so.35.0.0 \
...
/home/nataell/code/epAiland/paddle-highspeed-cpp/third_party/onnxruntime/lib/libonnxruntime.so:
