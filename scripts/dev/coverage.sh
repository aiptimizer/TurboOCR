...
#
# Usage:
#   scripts/dev/coverage.sh                 # build + ctest + report
#   scripts/dev/coverage.sh --no-build      # reuse build-coverage/, just re-run+report
#   COVERAGE_INTEGRATION=1 scripts/dev/coverage.sh
