...
// The device-free declaring header — NOT vlm_table.h, which also declares the
// CUDA-typed VLMTableRecognizer and would drag <cuda_runtime.h> into a TU that
// is linked into the CPU-only unified server.
