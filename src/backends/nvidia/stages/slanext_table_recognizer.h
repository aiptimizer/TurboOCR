...
#include "nvidia/stages/slanext_enc_split.h"
...
// per-cell quads; cells filled from the page text-OCR via table::slanext_postprocess_region (slanext_postprocess.h; match_cells_to_ocr +
// reconstruct_html.
