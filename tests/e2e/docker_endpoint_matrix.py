...
Usage:
    python tests/e2e/docker_endpoint_matrix.py                  # full matrix
    python tests/e2e/docker_endpoint_matrix.py --image gpu      # GPU only
    python tests/e2e/docker_endpoint_matrix.py --only latin     # one language
